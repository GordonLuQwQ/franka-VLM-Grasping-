...
static size_t _SetCartesianStiffness_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetCartesianStiffness_Request(
    full_bounded, 0);
}
...
static size_t _SetCartesianStiffness_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetCartesianStiffness_Response(
    full_bounded, 0);
}
