...
static size_t _SetFullCollisionBehavior_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetFullCollisionBehavior_Request(
    full_bounded, 0);
}
...
static size_t _SetFullCollisionBehavior_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetFullCollisionBehavior_Response(
    full_bounded, 0);
}
