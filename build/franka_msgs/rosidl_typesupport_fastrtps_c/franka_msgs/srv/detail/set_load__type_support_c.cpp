...
static size_t _SetLoad_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetLoad_Request(
    full_bounded, 0);
}
...
static size_t _SetLoad_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetLoad_Response(
    full_bounded, 0);
}
