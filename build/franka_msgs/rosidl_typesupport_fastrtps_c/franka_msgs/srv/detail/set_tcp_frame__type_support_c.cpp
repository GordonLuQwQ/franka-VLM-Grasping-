...
static size_t _SetTCPFrame_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetTCPFrame_Request(
    full_bounded, 0);
}
...
static size_t _SetTCPFrame_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_franka_msgs__srv__SetTCPFrame_Response(
    full_bounded, 0);
}
