...
{
  return max_serialized_size_SetForceTorqueCollisionBehavior_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_SetForceTorqueCollisionBehavior_Response(full_bounded, 0);
}
