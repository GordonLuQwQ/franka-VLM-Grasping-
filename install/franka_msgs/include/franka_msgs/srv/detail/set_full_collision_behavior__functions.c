  ...
  franka_msgs__srv__SetFullCollisionBehavior_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__srv__SetFullCollisionBehavior_Request * data =
      (franka_msgs__srv__SetFullCollisionBehavior_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__srv__SetFullCollisionBehavior_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__srv__SetFullCollisionBehavior_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__srv__SetFullCollisionBehavior_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__srv__SetFullCollisionBehavior_Response * data =
      (franka_msgs__srv__SetFullCollisionBehavior_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__srv__SetFullCollisionBehavior_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__srv__SetFullCollisionBehavior_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
